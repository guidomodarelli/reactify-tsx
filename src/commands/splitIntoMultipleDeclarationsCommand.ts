...
import {
  ...
  VARIABLE_SPLIT_MULTIPLE_SUCCESS_MESSAGE,
} from '../constants/messages';

const service = new VariableSplitService();

export async function splitIntoMultipleDeclarationsCommand(): Promise<void> {
  ...
  const result = service.createSplitMultiplePlan(document, selection);
  ...
  vscode.window.showInformationMessage(VARIABLE_SPLIT_MULTIPLE_SUCCESS_MESSAGE);
}
